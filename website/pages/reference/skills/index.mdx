...
- [Python](/reference/skills/standards-python) - PEP 8, type hints, async patterns
- [TypeScript](/reference/skills/standards-typescript) - Strict types, Zod, utility types
- [JavaScript](/reference/skills/standards-javascript) - ES Modules, async/await, Express
- [Shell/Bash](/reference/skills/standards-shell) - Defensive scripting, ShellCheck

## Tool Skills

Invoked manually or when relevant:

- [YouTube Transcript](/reference/skills/youtube-transcript) - Download transcripts with frame extraction
- [Slidev Presentations](/reference/skills/create-slidev-presentation) - Create slide decks
- [Skill Creator](/reference/skills/skill-creator) - Build your own skills
