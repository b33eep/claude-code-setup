...
This is different from [Skills](/reference/skills) (which are copied to `~/.claude/skills/`). External plugins are managed by Claude Code itself.

## Available Plugins

### Document Creation

- [document-skills](/reference/external-plugins/document-skills) - Excel, Word, PowerPoint, PDF

### Code Quality

- [code-review-ai](/reference/external-plugins/code-review-ai) - Architectural review (recommended)
