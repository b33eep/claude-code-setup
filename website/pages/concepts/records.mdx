...
**Tip:** Use [/design](/commands/design) for complex features - it creates structured Records automatically with Problem, Options, Solution, and User Stories sections.
