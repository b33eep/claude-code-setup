...
/design --review           # Get feedback (requires code-review-ai)
```
...
Claude: Reviewing design for "Add user notifications"...
        ...
        [invokes code-review-ai:architect-review]
...
Requires the [code-review-ai plugin](/features/external-plugins/code-review-ai).
...
- **Start with the problem** - A clear problem statement makes everything else easier
- **Don't over-design** - Skip Options step if there's only one viable approach
- **Stories should be independent** - Each story can be implemented and tested alone
- **High-risk stories first** - Fail fast on the hard parts
- **Review early** - Use `--review` before finalizing, not after
- **Resume freely** - Design survives `/clear`, continue anytime with `/design`
...
- [code-review-ai](/features/external-plugins/code-review-ai) - Design review
