...
When you correct Claude or share project knowledge ("This API expects ISO-8601", "Never use sudo here"),
Claude automatically persists it so the knowledge survives `/clear`:

- **Project facts and constraints** → Recent Decisions table
- **Personal preferences** → User Instructions (global CLAUDE.md)
- **Session-specific context** → Private Note

Claude will confirm briefly: "Noted in Recent Decisions."
...
When you hit these, stop and reassess the approach rather than pushing through.
